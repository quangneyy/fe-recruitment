    ...
    import { ActionType, FooterToolbar, ProForm, ProFormDatePicker, ProFormDigit, ProFormSelect, ProFormSwitch, ProFormText } from "@ant-design/pro-components";
    import styles from 'styles/admin.module.scss';
    import { LOCATION_LIST, SKILLS_LIST } from "@/config/utils";
    import { ICompanySelect } from "../user/modal.user";
    import { useState, useEffect, useRef } from 'react';
    import { callCreateJob, callFetchCompany, callFetchJobById, callUpdateJob, callUpdateUser } from "@/config/api";
    ...
    const ViewUpsertJob = (props: any) => {
        ...
        const reloadLayout = () => {
            try {
                // Chuyển hướng lại đến trang hiện tại để reload
                navigate(location.pathname);
            } catch (error) {
                console.error('Error in reloadLayout:', error);
            }
        };
                    ...
                    <ConfigProvider locale={enUS}>
                        <ProForm
                            ...
                            submitter={{
                                searchConfig: {
                                    resetText: "Hủy",
                                    submitText: <>{dataUpdate?._id ? "Cập nhật Job" : "Tạo mới Job(30.000)"}</>
                                },
